...
@REM python %SCRIPT_PATH% --xlsform-path "%EXCEL_OUTPUT_DIR%\xlsform_hab1-4.xlsx" --target-folder "Survey-LSVI App Test Auto" --manual_old_survey_id "60b8433d41af45c3b09c17039581e459"
